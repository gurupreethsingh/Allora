  ...
  return (
    <div>
        ...
        <div className='p-5 m-5'>
          <h1 className = "font-bold text-5xl text-center">Welcome to meneX Accessories</h1>
          <p className = " text-2xl text-center mt-2">Discover any unique patterns for fashion and design.</p>
          
      </div>
      <div className='flex justify-center'>
      <button className='bg-orange-600 text-white rounded-pill px-4 py-2'>Shop now</button>
      </div>
        ...
        {categories.map((category) => (
          <div key={category.id} className="p-4">
            <div className="p-4 rounded-lg shadow-md bg-white text-center">
              ...
              />
              <p className="text-center font-bold mt-3 mb-2 text-orange-600">{category.name}</p>

              <p className="text-center font-bold mt-3 mb-2 text-orange-600">10% off</p>
            </div>
          </div>
        ))}
      </Slider>
